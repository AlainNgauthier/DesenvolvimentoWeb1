...
public class Usuario {
	...
	//CLIENTE
	public Usuario(String email, String senha, String nome, String nascimento, String sexo,  String cpf, String categoria, String telefone) {
		super();
		this.email = email;
		this.senha = senha;
		this.nome = nome;
	...
	public Usuario(Long id, String email, String senha, String nome, String nascimento, String sexo,  String cpf, String categoria, String telefone) {
		super();
		this.id = id;
		this.email = email;
		this.senha = senha;
	...
	public void setNascnascimento(String nascimento) {
		this.nascimento = nascimento;
	}
